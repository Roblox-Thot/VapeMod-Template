...
local function getcustommodassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/".. shared.gitUser .."/"..shared.gitRepo .."/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/".. shared.gitUser .."/"..shared.gitRepo .."/main/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
		return pcall(function() return game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/CustomModules/"..id..".lua") end)
